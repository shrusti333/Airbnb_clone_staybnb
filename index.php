<?php 
session_start();
$qry="SELECT * FROM `userinfo` WHERE `User_ID`='{$_SESSION['uid']}'";
                ...
                <div class="start1">
                    ...
                    <div class="host-list">
                     ...
                     <div class="search-box">
                        <div class="box"><label>
                            <div class="location">
                             <div class="l"><div  class="l1">Location</div><div class="places-search"><input type="text" id="location"></div></div>  </div> 
                             ...
                             <div class="bu"><button class="button" type="submit" ><i class="fa-solid fa-magnifying-glass"></i></button></div></div>
                        </label> 
...
<tr>
     <td id="selectedc1"> <label class="input-fieldc1"><b>Password:-</b></label></td><td>
                        ...
                        <form class="input-infoc1" id="register" action="signup.php" method='post'>
                             <p id="errorc1"></p>
                            <table class="table1">
                                <tr class="tr1" >
                                    <td id="selectedc1">
                        ...
                        <tr class="tr1" >
                             ...
                             <input type="checkbox" class="check-boxc1"><span >i agree to terms and conditions</span>
                              <button class="submitbtnc1"   type="botton" onclick="check1()" > continue</button>
